...
const S3_BUCKET = "eap-storage-bucket-brady";
...
const CreatePDF = async ({ eapObject }) => {
  ...
  page1.drawText(`${eapObject.venueName}`, {
    x: 50,
    y: 780,
    size: 25,
    color: rgb(0, 0, 1),
  ...
  page1.drawText(
    `The terms Athletic Trainer and ATC are used interchangeably throughout this plan.`,
    { x: 50, y: 390, size: 10 }
  );
  page1.drawText(`Components of The Emergency Action Plan `, {
    x: 50,
    y: 330,
    size: 18,
    underline: true,
  ...
  page1.drawText(`1. Emergency Personnel and Roles`, {
    x: 100,
    y: 300,
    size: 10,
  });
  ...
  page1.drawText(
    `All members of the Athletic Department and all head and assistant coaches will be required to 
have current CPR/AED certifications.`,
    { x: 50, y: 170, size: 10 }
  );
  page1.drawText(
    `${bullet} ${eapObject.contact.name} - ${eapObject.contact.type} 
  ${eapObject.contact.phoneNumber} (Cell) ${eapObject.contact.email}`,
    { x: 100, y: 120, size: 10, color: rgb(0, 0, 1) }
  );
  ...
  page.drawText(`${bullet} Athletic trainer, coaches, administrators`, {
    x: 100,
    y: 700,
    size: 10,
  });
  ...
  page.drawText(
    `${bullet} Mobile phone carried by the ${eapObject.contact.type} (${eapObject.contact.name}):  ${eapObject.contact.phoneNumber}`,
    { x: 100, y: 620, size: 10 }
  );

  page.drawText("Emergency Equipment", { x: 75, y: 570, size: 14 });
  page.drawText(
    `${bullet} Basic first aid kit including tools for extraction of equipment, AED.`,
    { x: 100, y: 540, size: 10 }
  );
  ...
  page.drawText(
    "2) Emergency equipment retrieval – coaches, available personnel.",
    { x: 100, y: 430, size: 10 }
  );
  page.drawText("3) Activation of EMS – student, coach, or administrator.", {
    x: 100,
    y: 400,
    size: 10,
  });
  page.drawText(
    "a) 911 call (provide name, address, telephone number; number of individuals injured; condition of injured; first aid treatment;",
    { x: 150, y: 380, size: 9 }
  );
  page.drawText(
  ...
  page.drawText(
    "b) Notify parents as soon as possible (Consent papers have parent contact numbers)",
    { x: 150, y: 340, size: 9 }
  );

  const page2 = doc.addPage();
  page2.drawText(`Venue-Specific Emergency Action Plans `, {
    x: 50,
    y: 750,
    size: 18,
  });
  page2.drawText(
    `${eapObject.address.streetAddress}, ${eapObject.address.city}, ${eapObject.address.state}, ${eapObject.address.country} ${eapObject.address.zipCode}  `,
    { x: 100, y: 720, size: 10 }
  );
  ...
  acknowledgemnt.drawText(`Acknowledgement of EAP`, {
    x: 200,
    y: 750,
    size: 18,
  });
  acknowledgemnt.drawText(
    `By signing this, it states that you have read and understand the policies and procedures of The 
${eapObject.group} Emergency Action Plan. By signing, you understand to operate and 
follow these policies and procedures in the event of an emergency.`,
    { x: 100, y: 700, size: 10 }
  );
  acknowledgemnt.drawText(
    `Name:                                                                                                    Date:`,
  ...
  acknowledgemnt.drawText(
    ...
    { x: 50, y: 595, size: 10, color: rgb(0, 0, 1) }
  );
  acknowledgemnt.drawText(
    `Name:                                                                                                    Date:`,
    { x: 50, y: 545, size: 10 }
  ...
  acknowledgemnt.drawText(
    `__________________________________________________           _________________________`,
    { x: 50, y: 540, size: 10, color: rgb(0, 0, 1) }
  );
  acknowledgemnt.drawText(
    `Name:                                                                                                    Date:`,
    { x: 50, y: 490, size: 10 }
  ...
  acknowledgemnt.drawText(
    `__________________________________________________           _________________________`,
    { x: 50, y: 485, size: 10, color: rgb(0, 0, 1) }
  );
  acknowledgemnt.drawText(
    `Name:                                                                                                    Date:`,
    { x: 50, y: 435, size: 10 }
  ...
  acknowledgemnt.drawText(
    `__________________________________________________           _________________________`,
    { x: 50, y: 430, size: 10, color: rgb(0, 0, 1) }
  );
  acknowledgemnt.drawText(
    `Name:                                                                                                    Date:`,
    { x: 50, y: 380, size: 10 }
  ...
  acknowledgemnt.drawText(
    `__________________________________________________           _________________________`,
    { x: 50, y: 375, size: 10, color: rgb(0, 0, 1) }
  );
