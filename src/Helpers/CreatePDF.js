...
const CreatePDF = async ({ eapObject }) => {
  ...
  page.drawText(`Address: ${eapObject.address.streetAddress}`, {
    x: 50,
    y: 730,
  });
  page.drawText(`Address 2: ${eapObject.address.streetAddress2}`, {
    x: 50,
    y: 710,
  });
  ...
  page.drawText(`Phone Number: ${eapObject.contact.phoneNumber}`, {
    x: 50,
    y: 590,
  });
